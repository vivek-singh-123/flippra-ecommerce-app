...
// import 'package:flippra/screens/telugu_home_screen.dart'; // यह वर्तमान स्क्रीन है
...
class TeluguHomeScreen extends StatefulWidget { // क्लास का नाम बदला गया
  const TeluguHomeScreen({super.key});

  @override
  State<TeluguHomeScreen> createState() => _TeluguHomeScreenState(); // स्टेट क्लास का नाम बदला गया
}

class _TeluguHomeScreenState extends State<TeluguHomeScreen> { // स्टेट क्लास का नाम बदला गया
  int _selectedIndex = 2; // तेलुगु के लिए इंडेक्स 2 है
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 1:
        ...
        break;
      case 2:
      // पहले से ही तेलुगु स्क्रीन पर हैं, कोई नेविगेशन नहीं
        break;
      case 3:
        Navigator.pushReplacement(
          context,
