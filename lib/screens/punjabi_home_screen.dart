...
// import 'package:flippra/screens/punjabi_home_screen.dart'; // यह वर्तमान स्क्रीन है
...
class PunjabiHomeScreen extends StatefulWidget { // क्लास का नाम बदला गया
  const PunjabiHomeScreen({super.key});

  @override
  State<PunjabiHomeScreen> createState() => _PunjabiHomeScreenState(); // स्टेट क्लास का नाम बदला गया
}

class _PunjabiHomeScreenState extends State<PunjabiHomeScreen> { // स्टेट क्लास का नाम बदला गया
  int _selectedIndex = 4; // पंजाबी के लिए इंडेक्स 4 है
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 3:
        ...
        break;
      case 4:
      // पहले से ही पंजाबी स्क्रीन पर हैं, कोई नेविगेशन नहीं
        break;
      case 5:
        Navigator.pushReplacement(
          context,
