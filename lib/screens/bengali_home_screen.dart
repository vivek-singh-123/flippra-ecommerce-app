...
import 'package:flippra/screens/hindi_home_screen.dart'; // HindiHomeScreen को इम्पोर्ट करें
...
class BengaliHomeScreen extends StatefulWidget { // क्लास का नाम बदला गया
  const BengaliHomeScreen({super.key});

  @override
  State<BengaliHomeScreen> createState() => _BengaliHomeScreenState(); // स्टेट क्लास का नाम बदला गया
}

class _BengaliHomeScreenState extends State<BengaliHomeScreen> { // स्टेट क्लास का नाम बदला गया
  int _selectedIndex = 1; // बंगाली के लिए इंडेक्स 1 है
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
      // पहले से ही बंगाली स्क्रीन पर हैं, कोई नेविगेशन नहीं
        break;
      case 2:
        Navigator.pushReplacement(
          context,
